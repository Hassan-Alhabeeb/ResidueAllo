...
| Method | Year | Level | Model | Features | Training Set | Blind Benchmark |
|--------|------|-------|-------|----------|-------------|-----------------|
| DeepAllo | 2025 | Pocket | Multitask pLM | ProtBERT + pocket | 207 proteins | D24 (24 proteins) |
| AlloPED | 2025 | Both | XGBoost | ProtT5 + structural | 146 proteins | None |
| AlloFusion | 2025 | Residue | 1D CNN | ProtT5-LoRA + PSSM + Bio (1,047-dim) | 462 proteins | D24 (24 proteins) |
| STINGAllo | 2025 | Residue | CatBoost | 54 nanoenvironment descriptors | 230 proteins (376 chains) | ASBench (91 chains) |
| PASSer | 2023 | Pocket | Ensemble | FPocket features | 207 proteins | CASBench (80.5%) |
| **ResidueAllo** | **2026** | **Residue** | **XGBoost** | **9-source hybrid (232-dim)** | **2,043 proteins** | **CASBench (2,370)** |
